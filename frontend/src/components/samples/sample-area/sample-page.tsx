...
import { ShareDialog } from "@/components/samples/share-dialog";
...
import SampleAreaRoom from "./sample-area-room";
    ...
    <LiveblocksWrapper>
      <Base>
        <div className="flex h-full flex-1 gap-4 p-4 sm:p-8">
          <SampleAreaRoom roomName={roomName} username={username} sample={sample} disabled={disabled}></SampleAreaRoom>
